(function () {
  ...
  function ka(a, b, c, e) {
        ...
        if (((w = f[A]), 3 < w.length && 0 === w.indexOf("src")))
          if ("video" === e) {
            ...
            if (F) {
              ...
              ja.canPlayType("video/" + w.substring(3).toLowerCase())
            ) {
              ia[w] = 1;
              Fa = c[w];
              break;
    ...
    return Fa || c.src || c.href || a.src || a.href;
  }
  var q = {},
  ...
  function Cb(a) {
    L && ((a = a.deltaY), 0 > 0.5 * (0 > a ? 1 : a ? -1 : 0) ? eb() : db());
  }
  function W(a, b) {
